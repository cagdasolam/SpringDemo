...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/surveys/**").hasAnyAuthority("ROLE_USER")
                ...
                .antMatchers(HttpMethod.GET, "/options/**").hasAnyAuthority("ROLE_USER")
                ...
                .antMatchers("/auth/**")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/results/**").hasAnyAuthority("ROLE_USER")
